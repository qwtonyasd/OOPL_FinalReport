...
| 問題 | 解決方法 |
| :--- | :--- |
| 當實作箭塔發射的弓箭或砲塔發射的砲彈時，如果只是單純更新座標，子彈在空中飛行時看起來很怪，沒有隨著弧線上升下墜的真實物理感 | 當實作箭塔發射的弓箭或砲塔發射的砲彈時，如果只是單純更新座標，子彈在空中飛行時看起來很怪，沒有隨著弧線上升下墜的真實物理感 |


在`Projectile`類別中引入了三角函數運算，計算前後兩影格之間的動態位移向量夾角，並將該角度即時賦予
### 自評
